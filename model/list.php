...
<html lang="en">
    ...
    <div class="container">
        ...
        <?php include_once("../includes/sidebar.php"); ?>
            ...
            <div class="col-md-9">
                <h2><?=$L["model_form_list_title"] ?> <a href="add.php" class="btn btn-success float-right"><?=$L["add"] ?></a></h2>
                <?php
                ...
                <table class="table">
                    <tr>
                        <th><?=$L["model_form_id"] ?></th>
                        <th><?=$L["model_form_brand"] ?></th>
                        <th><?=$L["model_form_model"] ?></th>
                        <th><?=$L["options"] ?></th>
                    </tr>
                    <?php 
                        include_once("../includes/db_connect.php");
                        $sql = "SELECT model.*, brand.name as brand_name, model.name as model_name 
                        FROM model 
